...
|--------------------|------------------------------------|----------------------------------------|
| Pais e Alunos      | <br/> Cadastro do usuário. <br/> Que haja uma solicitação de documento para validação do cadastro. |Para que seja permitido o acesso a plataforma. <br/> Para que haja segurança para o usuário     |
