...
|Administrador da instituição|<br /> Cadastro do usuário. <br /> Gerenciar dados do aluno <br /> Interação entre os usuários da plataforma   | <br /> Para que seja permitido o acesso a plataforma. <br /> Para que haja comunicação entre as partes.|<br />  Para que seja monitorado a frequência do aluno nas aulas, tanto como notas, doações e participação. <br /> Para que haja comunicação entre as partes. |
> **Links Úteis**:
