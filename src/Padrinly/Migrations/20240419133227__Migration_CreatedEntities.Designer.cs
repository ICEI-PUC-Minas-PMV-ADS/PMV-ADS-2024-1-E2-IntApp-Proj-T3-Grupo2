...
namespace Padrinly.Migrations
{
    ...
    [Migration("20240419133227__Migration_CreatedEntities")]
    partial class _Migration_CreatedEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Padrinly.Domain.Entities.Mensage", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<int>", "Receiver")
                        .WithMany()
                        .HasForeignKey("IdReceiver")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<int>", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Padrinly.Domain.Entities.PersonPatron", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<int>", "Patron")
                        .WithMany()
                        .HasForeignKey("IdPatron")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<int>", "Student")
                        .WithMany()
